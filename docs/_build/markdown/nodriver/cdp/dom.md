...
### *class* CompatibilityMode(\*values)
...
### *class* ScrollOrientation(\*values)
...
#### parent_id *: [NodeId](#nodriver.cdp.dom.NodeId) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

The id of the parent node if any.

#### child_node_count *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Child count for `Container` nodes.

#### children *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[Node](#nodriver.cdp.dom.Node)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Child nodes of this node when requested with children.

#### attributes *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[str](https://docs.python.org/3/library/stdtypes.html#str)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Attributes of the `Element` node in the form of flat array `[name1, value1, name2, value2]`.

#### document_url *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
#### public_id *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

`DocumentType`’s publicId.

#### system_id *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

`DocumentType`’s systemId.

#### internal_subset *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

`DocumentType`’s internalSubset.

#### xml_version *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
#### pseudo_type *: [PseudoType](#nodriver.cdp.dom.PseudoType) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Pseudo element type for this node.

#### pseudo_identifier *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Pseudo element identifier for this node. Only present if there is a
valid pseudoType.

#### shadow_root_type *: [ShadowRootType](#nodriver.cdp.dom.ShadowRootType) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
#### content_document *: [Node](#nodriver.cdp.dom.Node) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Content document for frame owner elements.

#### shadow_roots *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[Node](#nodriver.cdp.dom.Node)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Shadow root list for given element host.

#### template_content *: [Node](#nodriver.cdp.dom.Node) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Content document fragment for template elements.

#### pseudo_elements *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[Node](#nodriver.cdp.dom.Node)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Pseudo elements associated with this node.

#### imported_document *: [Node](#nodriver.cdp.dom.Node) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Deprecated, as the HTML Imports API has been removed (crbug.com/937746).
This property used to return the imported document for the HTMLImport links.
The property is always undefined now.

#### distributed_nodes *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[BackendNode](#nodriver.cdp.dom.BackendNode)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Distributed nodes for given insertion point.

#### is_svg *: [bool](https://docs.python.org/3/library/functions.html#bool) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Whether the node is SVG.

#### compatibility_mode *: [CompatibilityMode](#nodriver.cdp.dom.CompatibilityMode) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

#### assigned_slot *: [BackendNode](#nodriver.cdp.dom.BackendNode) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

#### is_scrollable *: [bool](https://docs.python.org/3/library/functions.html#bool) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

#### affected_by_starting_styles *: [bool](https://docs.python.org/3/library/functions.html#bool) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

#### adopted_style_sheets *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[StyleSheetId](#nodriver.cdp.dom.StyleSheetId)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

#### ad_provenance *: [AdProvenance](network.md#nodriver.cdp.network.AdProvenance) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
#### a *: [float](https://docs.python.org/3/library/functions.html#float) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
#### shape_outside *: [ShapeOutsideInfo](#nodriver.cdp.dom.ShapeOutsideInfo) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
* **Parameters:**
  ...
  * **insert_before_node_id** ([`NodeId`](#nodriver.cdp.dom.NodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Drop the copy before this node (if absent, the copy becomes the last child of ``targetNodeId``).
* **Return type:**
...
* **Parameters:**
  * **node_id** ([`NodeId`](#nodriver.cdp.dom.NodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Identifier of the node.
  * **backend_node_id** ([`BackendNodeId`](#nodriver.cdp.dom.BackendNodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Identifier of the backend node.
  * **object_id** ([`RemoteObjectId`](runtime.md#nodriver.cdp.runtime.RemoteObjectId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* JavaScript object id of the node wrapper.
  * **depth** ([`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* The maximum depth at which children should be retrieved, defaults to 1. Use -1 for the entire subtree or provide an integer larger than 0.
  * **pierce** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Whether or not iframes and shadow roots should be traversed when returning the subtree (default is false).
* **Return type:**
...
* **Parameters:**
  **include_whitespace** ([`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`None`](https://docs.python.org/3/library/constants.html#None)) – **(EXPERIMENTAL)**  *(Optional)* Whether to include whitespaces in the children array of returned Nodes.
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`None`](https://docs.python.org/3/library/constants.html#None)]
...
* **Parameters:**
  ...
  * **anchor_specifier** ([`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* An optional anchor specifier, as defined in [https://www.w3.org/TR/css-anchor-position-1/#anchor-specifier](https://www.w3.org/TR/css-anchor-position-1/#anchor-specifier). If not provided, it will return the implicit anchor element for the given positioned element.
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`NodeId`](#nodriver.cdp.dom.NodeId)]
* **Returns:**
...
* **Parameters:**
  * **node_id** ([`NodeId`](#nodriver.cdp.dom.NodeId))
  * **container_name** ([`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)*
  * **physical_axes** ([`PhysicalAxes`](#nodriver.cdp.dom.PhysicalAxes) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)*
  * **logical_axes** ([`LogicalAxes`](#nodriver.cdp.dom.LogicalAxes) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)*
  * **queries_scroll_state** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)*
  * **queries_anchored** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)*
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`NodeId`](#nodriver.cdp.dom.NodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)]
* **Returns:**
...
* **Parameters:**
  ...
  * **include_user_agent_shadow_dom** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* False to skip to the nearest non-UA shadow root ancestor (default: false).
  * **ignore_pointer_events_none** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Whether to ignore pointer-events: none on elements and hit test them.
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Tuple`](https://docs.python.org/3/library/typing.html#typing.Tuple)[[`BackendNodeId`](#nodriver.cdp.dom.BackendNodeId), [`FrameId`](page.md#nodriver.cdp.page.FrameId), [`NodeId`](#nodriver.cdp.dom.NodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)]]
* **Returns:**
  A tuple with the following items:
  1. **backendNodeId** - Resulting node.
...
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`StackTrace`](runtime.md#nodriver.cdp.runtime.StackTrace) | [`None`](https://docs.python.org/3/library/constants.html#None)]
* **Returns:**
...
* **Parameters:**
  ...
  * **pierce** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Whether or not iframes and shadow roots in the same target should be traversed when returning the results (default is false).
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`List`](https://docs.python.org/3/library/typing.html#typing.List)[[`NodeId`](#nodriver.cdp.dom.NodeId)]]
* **Returns:**
  Resulting nodes.
...
* **Parameters:**
  ...
  * **backend_node_id** ([`BackendNodeId`](#nodriver.cdp.dom.BackendNodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Identifier of the backend node.
  * **object_id** ([`RemoteObjectId`](runtime.md#nodriver.cdp.runtime.RemoteObjectId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* JavaScript object id of the node wrapper.
  * **include_shadow_dom** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) – **(EXPERIMENTAL)**  *(Optional)* Include all shadow roots. Equals to false if not specified.
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`str`](https://docs.python.org/3/library/stdtypes.html#str)]
* **Returns:**
  Outer HTML markup.
...
* **Parameters:**
  ...
  * **insert_before_node_id** ([`NodeId`](#nodriver.cdp.dom.NodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Drop node before this one (if absent, the moved node becomes the last child of ``targetNodeId``).
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`NodeId`](#nodriver.cdp.dom.NodeId)]
* **Returns:**
...
* **Parameters:**
  ...
  * **include_user_agent_shadow_dom** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* True to search in user agent shadow DOM.
* **Return type:**
...
* **Parameters:**
  ...
  * **depth** ([`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* The maximum depth at which children should be retrieved, defaults to 1. Use -1 for the entire subtree or provide an integer larger than 0.
  * **pierce** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Whether or not iframes and shadow roots should be traversed when returning the sub-tree (default is false).
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`None`](https://docs.python.org/3/library/constants.html#None)]
...
* **Parameters:**
  * **node_id** ([`NodeId`](#nodriver.cdp.dom.NodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Id of the node to resolve.
  * **backend_node_id** ([`BackendNodeId`](#nodriver.cdp.dom.BackendNodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Backend identifier of the node to resolve.
  ...
  * **execution_context_id** ([`ExecutionContextId`](runtime.md#nodriver.cdp.runtime.ExecutionContextId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Execution context in which to resolve the node.
* **Return type:**
...
* **Parameters:**
  ...
  * **backend_node_id** ([`BackendNodeId`](#nodriver.cdp.dom.BackendNodeId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Identifier of the backend node.
  * **object_id** ([`RemoteObjectId`](runtime.md#nodriver.cdp.runtime.RemoteObjectId) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* JavaScript object id of the node wrapper.
  * **rect** ([`Rect`](#nodriver.cdp.dom.Rect) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* The rect to be scrolled into view, relative to the node’s border box, in CSS pixels. When omitted, center of the node will be used, similar to Element.scrollIntoView.
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`None`](https://docs.python.org/3/library/constants.html#None)]
...
* **Parameters:**
  ...
  * **name** ([`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Attribute name to replace with new attributes derived from text in case text parsed successfully.
* **Return type:**
  [`Generator`](https://docs.python.org/3/library/typing.html#typing.Generator)[[`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Dict`](https://docs.python.org/3/library/typing.html#typing.Dict)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`None`](https://docs.python.org/3/library/constants.html#None)]
...
### *class* AdoptedStyleSheetsModified(node_id, adopted_style_sheets)
...
#### adopted_style_sheets *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[StyleSheetId](#nodriver.cdp.dom.StyleSheetId)]*
...
### *class* AdRelatedStateUpdated(node_id, ad_provenance)
...
#### ad_provenance *: [AdProvenance](network.md#nodriver.cdp.network.AdProvenance) | [None](https://docs.python.org/3/library/constants.html#None)*

The provenance of the ad related node, if it is ad related.

### *class* AffectedByStartingStylesFlagUpdated(node_id, affected_by_starting_styles)
...
#### affected_by_starting_styles *: [bool](https://docs.python.org/3/library/functions.html#bool)*
