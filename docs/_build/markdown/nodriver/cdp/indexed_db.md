...
#### number *: [float](https://docs.python.org/3/library/functions.html#float) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Number value.

#### string *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

String value.

#### date *: [float](https://docs.python.org/3/library/functions.html#float) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Date value.

#### array *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[Key](#nodriver.cdp.indexed_db.Key)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
#### lower *: [Key](#nodriver.cdp.indexed_db.Key) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Lower bound.

#### upper *: [Key](#nodriver.cdp.indexed_db.Key) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
#### array *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[str](https://docs.python.org/3/library/stdtypes.html#str)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
* **Parameters:**
  * **security_origin** ([`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* At least and at most one of securityOrigin, storageKey, or storageBucket must be specified. Security origin.
  * **storage_key** ([`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Storage key.
  * **storage_bucket** ([`StorageBucket`](storage.md#nodriver.cdp.storage.StorageBucket) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Storage bucket. If not specified, it uses the default bucket.
...
### request_data(database_name, object_store_name, skip_count, page_size, security_origin=None, storage_key=None, storage_bucket=None, index_name=None, key_range=None)
...
* **Parameters:**
  ...
  * **database_name** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)) – Database name.
  * **object_store_name** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)) – Object store name.
  * **index_name** ([`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Index name. If not specified, it performs an object store data request.
  ...
  * **key_range** ([`KeyRange`](#nodriver.cdp.indexed_db.KeyRange) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Key range.
* **Return type:**
