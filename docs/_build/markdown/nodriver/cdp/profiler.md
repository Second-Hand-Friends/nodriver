...
#### hit_count *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Number of samples where this node was on top of the call stack.

#### children *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[int](https://docs.python.org/3/library/functions.html#int)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Child node ids.

#### deopt_reason *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

The reason of being not optimized. The function may be deoptimized or marked as don’t
optimize.

#### position_ticks *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[PositionTickInfo](#nodriver.cdp.profiler.PositionTickInfo)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
#### samples *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[int](https://docs.python.org/3/library/functions.html#int)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Ids of samples top nodes.

#### time_deltas *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[int](https://docs.python.org/3/library/functions.html#int)] | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
* **Parameters:**
  * **call_count** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Collect accurate call counts beyond simple ‘covered’ or ‘not covered’.
  * **detailed** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Collect block-based coverage.
  * **allow_triggered_updates** ([`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None)) –  *(Optional)* Allow the backend to send updates on its own initiative
* **Return type:**
