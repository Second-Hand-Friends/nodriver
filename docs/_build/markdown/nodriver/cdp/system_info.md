...
#### sub_sys_id *: [float](https://docs.python.org/3/library/functions.html#float) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

Sub sys ID of the GPU, only available on Windows.

#### revision *: [float](https://docs.python.org/3/library/functions.html#float) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
### *class* SubsamplingFormat(\*values)
...
### *class* GPUInfo(devices, driver_bug_workarounds, video_decoding, video_encoding, aux_attributes=None, feature_status=None)
...
#### aux_attributes *: [dict](https://docs.python.org/3/library/stdtypes.html#dict) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*

An optional dictionary of additional GPU related attributes.

#### feature_status *: [dict](https://docs.python.org/3/library/stdtypes.html#dict) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
