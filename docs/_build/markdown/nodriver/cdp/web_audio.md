...
### *class* ChannelInterpretation(\*values)
...
#### realtime_data *: [ContextRealtimeData](#nodriver.cdp.web_audio.ContextRealtimeData) | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
...
#### source_output_index *: [float](https://docs.python.org/3/library/functions.html#float) | [None](https://docs.python.org/3/library/constants.html#None)*

#### destination_input_index *: [float](https://docs.python.org/3/library/functions.html#float) | [None](https://docs.python.org/3/library/constants.html#None)*
