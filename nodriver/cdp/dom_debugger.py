...
class EventListener:
    ...
    def from_json(cls, json: T_JSON_DICT) -> EventListener:
        return cls(
            ...
            handler=runtime.RemoteObject.from_json(json.get('handler', None)) if json.get('handler', None) is not None else None,
            original_handler=runtime.RemoteObject.from_json(json.get('originalHandler', None)) if json.get('originalHandler', None) is not None else None,
