...
class DOMNode:
    ...
    def from_json(cls, json: T_JSON_DICT) -> DOMNode:
        return cls(
            ...
            text_value=str(json.get('textValue', None)) if json.get('textValue', None) is not None else None,
            input_value=str(json.get('inputValue', None)) if json.get('inputValue', None) is not None else None,
            input_checked=bool(json.get('inputChecked', None)) if json.get('inputChecked', None) is not None else None,
            option_selected=bool(json.get('optionSelected', None)) if json.get('optionSelected', None) is not None else None,
            child_node_indexes=[int(i) for i in json.get('childNodeIndexes', None)] if json.get('childNodeIndexes', None) is not None else None,
            attributes=[NameValue.from_json(i) for i in json.get('attributes', None)] if json.get('attributes', None) is not None else None,
            pseudo_element_indexes=[int(i) for i in json.get('pseudoElementIndexes', None)] if json.get('pseudoElementIndexes', None) is not None else None,
            layout_node_index=int(json.get('layoutNodeIndex', None)) if json.get('layoutNodeIndex', None) is not None else None,
            ...
            content_language=str(json.get('contentLanguage', None)) if json.get('contentLanguage', None) is not None else None,
            document_encoding=str(json.get('documentEncoding', None)) if json.get('documentEncoding', None) is not None else None,
            ...
            content_document_index=int(json.get('contentDocumentIndex', None)) if json.get('contentDocumentIndex', None) is not None else None,
            pseudo_type=dom.PseudoType.from_json(json.get('pseudoType', None)) if json.get('pseudoType', None) is not None else None,
            shadow_root_type=dom.ShadowRootType.from_json(json.get('shadowRootType', None)) if json.get('shadowRootType', None) is not None else None,
            is_clickable=bool(json.get('isClickable', None)) if json.get('isClickable', None) is not None else None,
            event_listeners=[dom_debugger.EventListener.from_json(i) for i in json.get('eventListeners', None)] if json.get('eventListeners', None) is not None else None,
            current_source_url=str(json.get('currentSourceURL', None)) if json.get('currentSourceURL', None) is not None else None,
            origin_url=str(json.get('originURL', None)) if json.get('originURL', None) is not None else None,
            scroll_offset_x=float(json.get('scrollOffsetX', None)) if json.get('scrollOffsetX', None) is not None else None,
            scroll_offset_y=float(json.get('scrollOffsetY', None)) if json.get('scrollOffsetY', None) is not None else None,
        )
...
class LayoutTreeNode:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LayoutTreeNode:
        return cls(
            ...
            bounding_box=dom.Rect.from_json(json['boundingBox']),
            layout_text=str(json.get('layoutText', None)) if json.get('layoutText', None) is not None else None,
            inline_text_nodes=[InlineTextBox.from_json(i) for i in json.get('inlineTextNodes', None)] if json.get('inlineTextNodes', None) is not None else None,
            style_index=int(json.get('styleIndex', None)) if json.get('styleIndex', None) is not None else None,
            paint_order=int(json.get('paintOrder', None)) if json.get('paintOrder', None) is not None else None,
            is_stacking_context=bool(json.get('isStackingContext', None)) if json.get('isStackingContext', None) is not None else None,
        )
...
class DocumentSnapshot:
    ...
    def from_json(cls, json: T_JSON_DICT) -> DocumentSnapshot:
        return cls(
            ...
            scroll_offset_x=float(json.get('scrollOffsetX', None)) if json.get('scrollOffsetX', None) is not None else None,
            scroll_offset_y=float(json.get('scrollOffsetY', None)) if json.get('scrollOffsetY', None) is not None else None,
            content_width=float(json.get('contentWidth', None)) if json.get('contentWidth', None) is not None else None,
            content_height=float(json.get('contentHeight', None)) if json.get('contentHeight', None) is not None else None,
        )
...
class NodeTreeSnapshot:
    ...
    def from_json(cls, json: T_JSON_DICT) -> NodeTreeSnapshot:
        return cls(
            parent_index=[int(i) for i in json.get('parentIndex', None)] if json.get('parentIndex', None) is not None else None,
            node_type=[int(i) for i in json.get('nodeType', None)] if json.get('nodeType', None) is not None else None,
            shadow_root_type=RareStringData.from_json(json.get('shadowRootType', None)) if json.get('shadowRootType', None) is not None else None,
            node_name=[StringIndex.from_json(i) for i in json.get('nodeName', None)] if json.get('nodeName', None) is not None else None,
            node_value=[StringIndex.from_json(i) for i in json.get('nodeValue', None)] if json.get('nodeValue', None) is not None else None,
            backend_node_id=[dom.BackendNodeId.from_json(i) for i in json.get('backendNodeId', None)] if json.get('backendNodeId', None) is not None else None,
            attributes=[ArrayOfStrings.from_json(i) for i in json.get('attributes', None)] if json.get('attributes', None) is not None else None,
            text_value=RareStringData.from_json(json.get('textValue', None)) if json.get('textValue', None) is not None else None,
            input_value=RareStringData.from_json(json.get('inputValue', None)) if json.get('inputValue', None) is not None else None,
            input_checked=RareBooleanData.from_json(json.get('inputChecked', None)) if json.get('inputChecked', None) is not None else None,
            option_selected=RareBooleanData.from_json(json.get('optionSelected', None)) if json.get('optionSelected', None) is not None else None,
            content_document_index=RareIntegerData.from_json(json.get('contentDocumentIndex', None)) if json.get('contentDocumentIndex', None) is not None else None,
            pseudo_type=RareStringData.from_json(json.get('pseudoType', None)) if json.get('pseudoType', None) is not None else None,
            pseudo_identifier=RareStringData.from_json(json.get('pseudoIdentifier', None)) if json.get('pseudoIdentifier', None) is not None else None,
            is_clickable=RareBooleanData.from_json(json.get('isClickable', None)) if json.get('isClickable', None) is not None else None,
            current_source_url=RareStringData.from_json(json.get('currentSourceURL', None)) if json.get('currentSourceURL', None) is not None else None,
            origin_url=RareStringData.from_json(json.get('originURL', None)) if json.get('originURL', None) is not None else None,
        )
...
class LayoutTreeSnapshot:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LayoutTreeSnapshot:
        return cls(
            ...
            paint_orders=[int(i) for i in json.get('paintOrders', None)] if json.get('paintOrders', None) is not None else None,
            offset_rects=[Rectangle.from_json(i) for i in json.get('offsetRects', None)] if json.get('offsetRects', None) is not None else None,
            scroll_rects=[Rectangle.from_json(i) for i in json.get('scrollRects', None)] if json.get('scrollRects', None) is not None else None,
            client_rects=[Rectangle.from_json(i) for i in json.get('clientRects', None)] if json.get('clientRects', None) is not None else None,
            blended_background_colors=[StringIndex.from_json(i) for i in json.get('blendedBackgroundColors', None)] if json.get('blendedBackgroundColors', None) is not None else None,
            text_color_opacities=[float(i) for i in json.get('textColorOpacities', None)] if json.get('textColorOpacities', None) is not None else None,
        )
