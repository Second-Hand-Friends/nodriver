...
class StorageId:
    ...
    def from_json(cls, json: T_JSON_DICT) -> StorageId:
        return cls(
            ...
            security_origin=str(json.get('securityOrigin', None)) if json.get('securityOrigin', None) is not None else None,
            storage_key=SerializedStorageKey.from_json(json.get('storageKey', None)) if json.get('storageKey', None) is not None else None,
        )
