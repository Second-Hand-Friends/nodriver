...
class LargestContentfulPaint:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LargestContentfulPaint:
        return cls(
            ...
            element_id=str(json.get('elementId', None)) if json.get('elementId', None) is not None else None,
...
class TimelineEvent:
    ...
    def from_json(cls, json: T_JSON_DICT) -> TimelineEvent:
        return cls(
            ...
            duration=float(json.get('duration', None)) if json.get('duration', None) is not None else None,
            lcp_details=LargestContentfulPaint.from_json(json.get('lcpDetails', None)) if json.get('lcpDetails', None) is not None else None,
            layout_shift_details=LayoutShift.from_json(json.get('layoutShiftDetails', None)) if json.get('layoutShiftDetails', None) is not None else None,
        )
