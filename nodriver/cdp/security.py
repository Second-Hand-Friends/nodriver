...
class CertificateSecurityState:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CertificateSecurityState:
        return cls(
            ...
            certificate_network_error=str(json.get('certificateNetworkError', None)) if json.get('certificateNetworkError', None) is not None else None,
        )
...
class SafetyTipInfo:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SafetyTipInfo:
        return cls(
            ...
            safe_url=str(json.get('safeUrl', None)) if json.get('safeUrl', None) is not None else None,
        )
...
class VisibleSecurityState:
    ...
    def from_json(cls, json: T_JSON_DICT) -> VisibleSecurityState:
        return cls(
            ...
            certificate_security_state=CertificateSecurityState.from_json(json.get('certificateSecurityState', None)) if json.get('certificateSecurityState', None) is not None else None,
            safety_tip_info=SafetyTipInfo.from_json(json.get('safetyTipInfo', None)) if json.get('safetyTipInfo', None) is not None else None,
        )
...
class SecurityStateExplanation:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SecurityStateExplanation:
        return cls(
            ...
            certificate=[str(i) for i in json['certificate']],
            recommendations=[str(i) for i in json.get('recommendations', None)] if json.get('recommendations', None) is not None else None,
        )
...
class SecurityStateChanged:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SecurityStateChanged:
        return cls(
            ...
            summary=str(json.get('summary', None)) if json.get('summary', None) is not None else None
        )
