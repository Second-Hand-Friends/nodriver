...
class ReaderStateFlags:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ReaderStateFlags:
        return cls(
            unaware=bool(json.get('unaware', None)) if json.get('unaware', None) is not None else None,
            ignore=bool(json.get('ignore', None)) if json.get('ignore', None) is not None else None,
            changed=bool(json.get('changed', None)) if json.get('changed', None) is not None else None,
            unknown=bool(json.get('unknown', None)) if json.get('unknown', None) is not None else None,
            unavailable=bool(json.get('unavailable', None)) if json.get('unavailable', None) is not None else None,
            empty=bool(json.get('empty', None)) if json.get('empty', None) is not None else None,
            present=bool(json.get('present', None)) if json.get('present', None) is not None else None,
            exclusive=bool(json.get('exclusive', None)) if json.get('exclusive', None) is not None else None,
            inuse=bool(json.get('inuse', None)) if json.get('inuse', None) is not None else None,
            mute=bool(json.get('mute', None)) if json.get('mute', None) is not None else None,
            unpowered=bool(json.get('unpowered', None)) if json.get('unpowered', None) is not None else None,
        )
...
class ProtocolSet:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ProtocolSet:
        return cls(
            t0=bool(json.get('t0', None)) if json.get('t0', None) is not None else None,
            t1=bool(json.get('t1', None)) if json.get('t1', None) is not None else None,
            raw=bool(json.get('raw', None)) if json.get('raw', None) is not None else None,
        )
...
class GetStatusChangeRequested:
    ...
    def from_json(cls, json: T_JSON_DICT) -> GetStatusChangeRequested:
        return cls(
            ...
            timeout=int(json.get('timeout', None)) if json.get('timeout', None) is not None else None
        )
...
class TransmitRequested:
    ...
    def from_json(cls, json: T_JSON_DICT) -> TransmitRequested:
        return cls(
            ...
            handle=int(json['handle']),
            data=str(json['data']),
            protocol=Protocol.from_json(json.get('protocol', None)) if json.get('protocol', None) is not None else None
        )
