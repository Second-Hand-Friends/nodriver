...
class SharedStoragePrivateAggregationConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SharedStoragePrivateAggregationConfig:
        return cls(
            ...
            aggregation_coordinator_origin=str(json.get('aggregationCoordinatorOrigin', None)) if json.get('aggregationCoordinatorOrigin', None) is not None else None,
            context_id=str(json.get('contextId', None)) if json.get('contextId', None) is not None else None,
            max_contributions=int(json.get('maxContributions', None)) if json.get('maxContributions', None) is not None else None,
        )
...
class SharedStorageAccessParams:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SharedStorageAccessParams:
        return cls(
            script_source_url=str(json.get('scriptSourceUrl', None)) if json.get('scriptSourceUrl', None) is not None else None,
            data_origin=str(json.get('dataOrigin', None)) if json.get('dataOrigin', None) is not None else None,
            operation_name=str(json.get('operationName', None)) if json.get('operationName', None) is not None else None,
            operation_id=str(json.get('operationId', None)) if json.get('operationId', None) is not None else None,
            keep_alive=bool(json.get('keepAlive', None)) if json.get('keepAlive', None) is not None else None,
            private_aggregation_config=SharedStoragePrivateAggregationConfig.from_json(json.get('privateAggregationConfig', None)) if json.get('privateAggregationConfig', None) is not None else None,
            serialized_data=str(json.get('serializedData', None)) if json.get('serializedData', None) is not None else None,
            urls_with_metadata=[SharedStorageUrlWithMetadata.from_json(i) for i in json.get('urlsWithMetadata', None)] if json.get('urlsWithMetadata', None) is not None else None,
            urn_uuid=str(json.get('urnUuid', None)) if json.get('urnUuid', None) is not None else None,
            key=str(json.get('key', None)) if json.get('key', None) is not None else None,
            value=str(json.get('value', None)) if json.get('value', None) is not None else None,
            ignore_if_present=bool(json.get('ignoreIfPresent', None)) if json.get('ignoreIfPresent', None) is not None else None,
            worklet_ordinal=int(json.get('workletOrdinal', None)) if json.get('workletOrdinal', None) is not None else None,
            worklet_target_id=target.TargetID.from_json(json.get('workletTargetId', None)) if json.get('workletTargetId', None) is not None else None,
            with_lock=str(json.get('withLock', None)) if json.get('withLock', None) is not None else None,
            batch_update_id=str(json.get('batchUpdateId', None)) if json.get('batchUpdateId', None) is not None else None,
            batch_size=int(json.get('batchSize', None)) if json.get('batchSize', None) is not None else None,
        )
...
class InterestGroupAccessed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InterestGroupAccessed:
        return cls(
            ...
            name=str(json['name']),
            component_seller_origin=str(json.get('componentSellerOrigin', None)) if json.get('componentSellerOrigin', None) is not None else None,
            bid=float(json.get('bid', None)) if json.get('bid', None) is not None else None,
            bid_currency=str(json.get('bidCurrency', None)) if json.get('bidCurrency', None) is not None else None,
            unique_auction_id=InterestGroupAuctionId.from_json(json.get('uniqueAuctionId', None)) if json.get('uniqueAuctionId', None) is not None else None
        )
...
class InterestGroupAuctionEventOccurred:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InterestGroupAuctionEventOccurred:
        return cls(
            ...
            parent_auction_id=InterestGroupAuctionId.from_json(json.get('parentAuctionId', None)) if json.get('parentAuctionId', None) is not None else None,
            auction_config=dict(json.get('auctionConfig', None)) if json.get('auctionConfig', None) is not None else None
        )
