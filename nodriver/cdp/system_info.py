...
class GPUDevice:
    ...
    def from_json(cls, json: T_JSON_DICT) -> GPUDevice:
        return cls(
            ...
            sub_sys_id=float(json.get('subSysId', None)) if json.get('subSysId', None) is not None else None,
            revision=float(json.get('revision', None)) if json.get('revision', None) is not None else None,
        )
...
class GPUInfo:
    ...
    def from_json(cls, json: T_JSON_DICT) -> GPUInfo:
        return cls(
            ...
            aux_attributes=dict(json.get('auxAttributes', None)) if json.get('auxAttributes', None) is not None else None,
            feature_status=dict(json.get('featureStatus', None)) if json.get('featureStatus', None) is not None else None,
        )
