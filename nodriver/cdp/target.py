...
class TargetInfo:
    ...
    def from_json(cls, json: T_JSON_DICT) -> TargetInfo:
        return cls(
            ...
            parent_id=TargetID.from_json(json.get('parentId', None)) if json.get('parentId', None) is not None else None,
            opener_id=TargetID.from_json(json.get('openerId', None)) if json.get('openerId', None) is not None else None,
            opener_frame_id=page.FrameId.from_json(json.get('openerFrameId', None)) if json.get('openerFrameId', None) is not None else None,
            parent_frame_id=page.FrameId.from_json(json.get('parentFrameId', None)) if json.get('parentFrameId', None) is not None else None,
            browser_context_id=browser.BrowserContextID.from_json(json.get('browserContextId', None)) if json.get('browserContextId', None) is not None else None,
...
class FilterEntry:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FilterEntry:
        return cls(
            exclude=bool(json.get('exclude', None)) if json.get('exclude', None) is not None else None,
...
def get_browser_contexts() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,typing.Tuple[typing.List[browser.BrowserContextID], typing.Optional[browser.BrowserContextID]]]:
    ...
    return (
        ...
        browser.BrowserContextID.from_json(json.get('defaultBrowserContextId', None)) if json.get('defaultBrowserContextId', None) is not None else None
    )
...
def get_dev_tools_target(
    ...
    **EXPERIMENTAL**
    ...
    json = yield cmd_dict
    return TargetID.from_json(json.get('targetId', None)) if json.get('targetId', None) is not None else None
...
class DetachedFromTarget:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> DetachedFromTarget:
        return cls(
            session_id=SessionID.from_json(json['sessionId']),
            target_id=TargetID.from_json(json.get('targetId', None)) if json.get('targetId', None) is not None else None
        )
