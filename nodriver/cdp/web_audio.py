...
class BaseAudioContext:
    ...
    def from_json(cls, json: T_JSON_DICT) -> BaseAudioContext:
        return cls(
            ...
            realtime_data=ContextRealtimeData.from_json(json.get('realtimeData', None)) if json.get('realtimeData', None) is not None else None,
        )
...
class NodesConnected:
    ...
    def from_json(cls, json: T_JSON_DICT) -> NodesConnected:
        return cls(
            ...
            source_output_index=float(json.get('sourceOutputIndex', None)) if json.get('sourceOutputIndex', None) is not None else None,
            destination_input_index=float(json.get('destinationInputIndex', None)) if json.get('destinationInputIndex', None) is not None else None
        )
